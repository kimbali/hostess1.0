...
class NewEvent extends Component {
    ...
    handleSubmit = event => {
        ...
        logic.newEvent(this.props.id, location, date, hours, salary, title, goal, this.props.token)
            .then(() => this.props.history.push(`/business/events`))
    ...
    render() {
        ...
        return (
            <div>
                <HomeButton event={'business/events'} buttonName={'go to my events'} />
                <div className="big">
                    <div className="left">
                    <p>
                    ...
                    <div className="right">
                        ...
                        <div className="required-camps">All camps are required in order achieve better results with the workers</div>
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div>
                                <input type="text" placeholder="Total salary in €" onChange={this.handleSalary}></input>
                            </div>
                            <div >
